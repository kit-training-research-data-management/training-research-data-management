---
title: 2.2 Organizing data collection (Collect & Analyse)
author: RDM@KIT
tags:
  - FAIR-by-Design
  - Learning
...
# 2.2 Organizing data collection (Collect & Analyse)

Introduction

## 2.2.1 Data organization: file naming, folder hierarchy, versioning and version control, GIN Tonic

Here goes the content of the learning unit divided into a number of subtopics and any additional headings as necessary.

## 2.2.2 Data documentation: readme files, data dictionary, metadata, OpenRefine, ELN , ELN-Finder
