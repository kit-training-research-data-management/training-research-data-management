...
# 2.3 Storing data (Preserve & Store)

Introduction

## 2.3.1 Backup and storage: 3-2-1 rule, raw and sensitive data, SCC-Services

Here goes the content of the learning unit divided into a number of subtopics and any additional headings as necessary.

## 2.3.2 Repositories: general: zenodo…, institutional: KITOpen, RADA4KIT, discipline specific: Pangea... repositories at KIT
