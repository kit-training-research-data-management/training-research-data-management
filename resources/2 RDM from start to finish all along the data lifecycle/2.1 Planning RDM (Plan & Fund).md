---
title: 2.1 Planning RDM (Plan & Fund)
author: RDM@KIT
tags:
  - FAIR-by-Design
  - Learning
...
# 2.1 Planning RDM (Plan & Fund)

Introduction

## 2.1.1 Data inventory, data management plan, funder requirements, dmp tools

Here goes the content of the learning unit divided into a number of subtopics and any additional headings as necessary.

## 2.1.2 Legal issues: copyright, data protection, intellectual property, SGRP, iVA (interactive virtual assistant)
